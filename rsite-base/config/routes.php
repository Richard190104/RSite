...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $builder): void {
        ...
        $builder->connect('/poplatky', ['controller' => 'Pages', 'action' => 'poplatky']);
    ...
    /*
     * Admin section, only reachable under /admin.
     * Controllers live in src/Controller/Admin/ (namespace App\Controller\Admin),
